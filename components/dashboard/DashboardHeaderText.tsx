    ...
    <DashboardContainer className={'flex flex-col 600:flex-row gap-y-4 600:items-center justify-between'}>
      ...
      {viewMode && (
        <Button
          ...
          className={
            'flex max-w-[13.625rem] h-12 items-center justify-center rounded-[8px] gap-x-2 px-4 bg-steel-blue/5 '
          }
        >
          {viewMode === 'calendar'
            ? <ListIcon className={'!size-5 text-steel-blue'} />
            : <CalendarIcon className={'!size-5 text-steel-blue'} />}
